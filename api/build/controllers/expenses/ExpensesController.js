...
var ExpensesController = /** @class */ (function () {
    function ExpensesController() {
        ...
        this.crudServices.setEntity(Expense_1.Expense);
    }
    ExpensesController.prototype.getExpenseById = function (id) {
    ...
    ExpensesController.prototype.getExpenses = function (paginationInfo, search) {
        return __awaiter(this, void 0, void 0, function () {
            var query;
            return __generator(this, function (_a) {
                switch (_a.label) {
    ...
    ExpensesController.prototype.createNewExpense = function (Expense, userid) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.crudServices.create(userid, Expense)];
                    case 1: return [2 /*return*/, _a.sent()];
                }
            });
        });
    };
    ExpensesController.prototype.updateExpense = function (id, data, userid) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
    ...
    ExpensesController.prototype.deleteExpense = function (id) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
    ...
    __decorate([
        ...
        __metadata("design:type", Function),
        __metadata("design:paramtypes", [Expense_1.Expense, String]),
        __metadata("design:returntype", Promise)
    ], ExpensesController.prototype, "createNewExpense", null);
    __decorate([
        ...
        __metadata("design:type", Function),
        __metadata("design:paramtypes", [String, Expense_1.Expense, String]),
        __metadata("design:returntype", Promise)
    ...
    ExpensesController = __decorate([
        routing_controllers_1.JsonController("/expenses"),
