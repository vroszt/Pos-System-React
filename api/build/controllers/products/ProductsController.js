...
var ProductsController = /** @class */ (function () {
    function ProductsController() {
        ...
        this.crudServices.setEntity(Product_1.Product);
    }
    ...
    ProductsController.prototype.getProducts = function (paginationInfo, search) {
        return __awaiter(this, void 0, void 0, function () {
            var query;
            return __generator(this, function (_a) {
                switch (_a.label) {
    ...
    ProductsController.prototype.createNewProduct = function (product, userid) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.crudServices.create(userid, product)];
                    case 1: return [2 /*return*/, _a.sent()];
                }
            });
        });
    };
    ProductsController.prototype.updateProduct = function (id, data, userid) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
    ...
    __decorate([
        ...
        __metadata("design:type", Function),
        __metadata("design:paramtypes", [String, Product_1.Product, String]),
        __metadata("design:returntype", Promise)
