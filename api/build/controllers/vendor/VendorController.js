...
var VendorsController = /** @class */ (function () {
    function VendorsController() {
        this.crudServices = new CrudServices_1.CrudServices();
        this.crudServices.setEntity(Vendor_1.Vendor);
    }
    VendorsController.prototype.getVendorById = function (id) {
    ...
    VendorsController.prototype.getVendors = function (paginationInfo, search) {
        return __awaiter(this, void 0, void 0, function () {
            var query;
            return __generator(this, function (_a) {
                switch (_a.label) {
    ...
    VendorsController.prototype.createNewVendor = function (Vendor, userid) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.crudServices.create(userid, Vendor)];
                    case 1: return [2 /*return*/, _a.sent()];
                }
            });
        });
    };
    VendorsController.prototype.updateVendor = function (id, data, userid) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
    ...
    VendorsController.prototype.deleteVendor = function (id) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
    ...
    __decorate([
        ...
        __metadata("design:type", Function),
        __metadata("design:paramtypes", [Vendor_1.Vendor, String]),
        __metadata("design:returntype", Promise)
    ], VendorsController.prototype, "createNewVendor", null);
    __decorate([
        ...
        __metadata("design:type", Function),
        __metadata("design:paramtypes", [String, Vendor_1.Vendor, String]),
        __metadata("design:returntype", Promise)
    ...
    VendorsController = __decorate([
        routing_controllers_1.JsonController("/vendors"),
