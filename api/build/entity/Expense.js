...
var Expense = /** @class */ (function (_super) {
    ...
    ], Expense.prototype, "spentAt", void 0);
    __decorate([
        typeorm_1.ManyToOne(function (type) { return ExpenseType_1.ExpenseType; }, { onDelete: "RESTRICT", onUpdate: "CASCADE" }),
        typeorm_1.JoinColumn({ name: "expenseTypeId" }),
